...
namespace FChatDicebot.Model
{
    ...
    public class ViceInstance
    {
        ...
        {
            return ProfileListStore<ViceInstance>.LoadAll(profile, VicesListKey,
                entry => !string.IsNullOrEmpty(entry.Vice));
        }
        ...
        {
            ProfileListStore<ViceInstance>.SaveAll(profile, VicesListKey, entries);
        }
    }
}
